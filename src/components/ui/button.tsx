  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient:
          "gradient-primary text-primary-foreground shadow-sm hover:shadow-xbox active:scale-[0.98]",
        destructive:
        ...
        // Xbox-style variants
        xbox:
          "bg-primary text-primary-foreground shadow-xbox hover:shadow-glow active:scale-[0.98] border border-primary/50",
        "xbox-outline":
