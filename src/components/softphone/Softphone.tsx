...
import { Phone, Minus, Mic, MicOff, Pause, Play, PhoneOff, Delete, MessageSquare } from 'lucide-react';
...
export const Softphone = () => {
  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 z-50 w-[320px] h-[480px] bg-slate-900 rounded-2xl shadow-2xl overflow-hidden flex flex-col border border-slate-700/50">
        {/* Header */}
        ...
        {/* Tabs for Phone/SMS */}
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'phone' | 'sms')} className="flex-1 flex flex-col overflow-hidden">
          <TabsList className="grid w-full grid-cols-2 bg-slate-800/50 rounded-none border-b border-slate-700/50 h-10">
            <TabsTrigger 
              value="phone" 
              className="data-[state=active]:bg-slate-700 data-[state=active]:text-slate-100 text-slate-400 rounded-none"
            >
            ...
            <TabsTrigger 
              value="sms" 
              className="data-[state=active]:bg-slate-700 data-[state=active]:text-slate-100 text-slate-400 rounded-none relative"
            >
          ...
          {/* Phone Tab Content */}
          <TabsContent value="phone" className="flex-1 overflow-hidden m-0">
            {/* Active Call Display */}
            {currentCall ? (
          ...
          <TabsContent value="sms" className="flex-1 overflow-hidden m-0">
            <SoftphoneSMS unreadCount={unreadSmsCount} />
          </TabsContent>
        </Tabs>
      </div>
